...
public final class Essai {
    public static void main(final String... args)
        throws IOException, ProcessingException {
        JsonNode schema_structure =  JsonLoader.fromFile(new File("monschema.json"));
        JsonNode structure_a_valider= JsonLoader.fromFile(new File("structure.json"));
        ...
        if (report.isSuccess())
            System.out.println ("*** La structure est valide! ***");
        else
            System.out.println ("*** La structure est invalide! *** ");
        System.out.println ("");
